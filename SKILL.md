---
name: design-system-financy-community
description: Creates implementation-ready design-system guidance derived from local Figma styles in "Financy (Community)".
---
...
## Mission
Document and operationalize the Financy (Community) style foundations extracted from Figma so teams can build consistent interfaces quickly.

## Brand
- Product/brand: Financy (Community)
...
- Color palette: Brand/brand-dark, Brand/brand-base, Grayscale/gray-800, Grayscale/gray-700, Grayscale/gray-600, Grayscale/gray-500, Grayscale/gray-400, Grayscale/gray-300, Grayscale/gray-200, Grayscale/gray-100, Neutral/black, Neutral/white, Blue/blue-dark, Blue/blue-base
...
## Rules: Do
- Use extracted color tokens before introducing one-off values: Brand/brand-dark
- Brand/brand-base
- Grayscale/gray-800
- Grayscale/gray-700
- Grayscale/gray-600
